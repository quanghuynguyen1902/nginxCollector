...
def push_data_kafka(authorization_field, collection, map_user, app_id, datas):
    for data in datas:
    ...
    if(len(paths) > 0):
        ...
        if(filename):
            ...
            try:  
                ...
                push_data_kafka(authorization_field, collection, map_user, app_id, datas)
            except:
        ...
        for filename in filename_array:
            ...
            try:  
                ...
                filename_array.remove(filename)
